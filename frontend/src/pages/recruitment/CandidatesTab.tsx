      ...
      if (job.candidates && job.candidates.length > 0) {
        job.candidates.forEach((c: any) => {
          list.push({
            ...
            rating: c.screenings?.[0]?.overallScreeningScore ? `${c.screenings[0].overallScreeningScore}/5` : 'N/A',
            ...
            experience: c.experience || (c.candidateType === 'FRESHER' ? 'Fresher (0 Years)' : 'N/A'),
            qualification: c.qualification || 'Graduate',
            currentLocation: c.currentLocation || 'N/A',
            currentCompany: c.currentCompany || 'N/A',
            skills: c.skills || '',
            ...
            atsAnalysis: c.atsAnalysis || null,
          });
        });
      }
    });
