...
export default function LoginPage() {
  ...
  return (
    <div className={`relative min-h-screen w-full overflow-hidden bg-slate-50 transition-opacity duration-700 dark:bg-slate-950 ${
      isSuccessTransitioning ? 'opacity-0 scale-98 pointer-events-none' : 'opacity-100 scale-100'
    }`}>
              ...
              <div className="space-y-5">
                ...
                <div className="relative flex rounded-2xl bg-slate-100 dark:bg-slate-900/80 p-1 border border-slate-200/60 dark:border-slate-800">
                  ...
                  <button
                    ...
                    className={`relative z-10 flex-1 py-2 text-xs font-semibold transition-colors cursor-pointer ${
                      activeTab === 'signin'
